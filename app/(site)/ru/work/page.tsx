...
/**
 * RU mirror of /work. Same data path as EN — `workIndexQuery` returns linkable
 * case studies — but cards link via `slugRu` so each row points at /ru/work/[slugRu].
 */
export default async function WorkIndexPageRu() {
      ...
      <section className="border-b border-rule">
        <Container className="py-24 md:py-32 lg:py-40">
          ...
          <h1 className="mt-4 max-w-5xl text-balance font-serif text-5xl leading-[1.05] tracking-tight text-ink md:text-6xl lg:text-7xl">
            Реальные AI-внедрения с измеримым результатом.
          </h1>
        </Container>
      </section>
