...
/**
 * EN /about page. Reads the aboutPage singleton (with `founder` reference
 * dereffed inline by `aboutPageQuery`).
 *
 * AI-first MVP composition (each section returns null when its source is empty):
 *   1. Hero — heroStatement at page-hero scale.
 *   2. Founder — eyebrow + optional photo + name + role + bio.
 *   3. How we work — principles[] as a hairline-separated list (4|8 spine).
 *   4. Expertise — expertiseAreas[] as a 2-col grid in col-span-8.
 *   5. Final CTA — closing button driven by aboutPage.finalCta.
 *
 * Portable Text fields (whatItIsEn/Ru, howWeWorkEn/Ru) are not rendered yet —
 * no Portable Text renderer is wired into the project. heroStatement plus
 * principles cover the same conceptual ground for MVP. Expand once a Portable
 * Text renderer (e.g. @portabletext/react) is added for blog and case-study
 * bodies.
 */
