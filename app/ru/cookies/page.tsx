...
export const metadata: Metadata = buildMetadata({
  locale: "ru",
  path: "/cookies",
  title: "Cookies — FIRFAROV",
});

export default function CookiesPageRu() {
  return (
    <Container className="py-24">
      <p className="font-mono text-xs uppercase tracking-widest text-ink-muted">Правовая информация</p>
      <h1 className="mt-4 font-serif text-4xl text-ink md:text-5xl">Cookies</h1>
      <p className="mt-6 max-w-prose text-ink-muted">
        ...
        slug <code className="font-mono text-xs">cookies</code>).
      </p>
    </Container>
  );
}
